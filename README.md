...
### Overview
This is an app created for EPSON Moverio BT-300 smart glasses to aid the visually impaired avoid collisions. The glasses are attached to a controller running on Android™ 5.1. The device camera used perform real-time object detection on the eyeglasses. The app uses TensorFlow Lite, an open source deep learning framework for on device inference. 
